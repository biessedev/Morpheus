...
'            strRuleCheck = HeaderFileNameExstensionRuleCheck()
...
'            If strRevCheck <> "5029" And strRevCheck <> strSintaxCheck Then
...
'                            Else
'                                If MsgBox("The file is not in the server. Do you want to load it with the revision index greater than 0?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
'                                    strLoaded = loadCreFile(False)
'                                    ComunicationLog(strLoaded)
'                                Else
...
'                                    If MsgBox("The file is already present in the server. Do you want to replace it?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
...
'                End If
'            Else
'                RevisionExtract = ("0019") ' "Error in revision extract
'            End If
'        Catch ex As Exception
...
'            End If
'        Catch ex As Exception
'            SignExtract = ("0041") ' "Error in sign extract
'        End Try
...
'                                End If
'                            Else
'                                PathSintaxAnalysis = ("0019") ' "Revision Sintax Error!"
...
'    Function HeaderFileNameExstensionRuleCheck() As String
...
'            HeaderFileNameExstensionRuleCheck = IIf(BooAux, "5026", "0024") ' Error in document type or in extension

'        Catch ex As Exception
'            HeaderFileNameExstensionRuleCheck = "0023" 'Generic error in header, filename and/or extension
'        End Try
'    End Function
...
'    ' fill the combo of revision note. in future can use for manage the ecr
'    '
...
'    Private Sub TextBoxHeader_TextChanged(sender As Object, e As EventArgs) Handles TextBoxHeader.TextChanged

'    End Sub

'    Private Sub TextBoxDocName_TextChanged(sender As Object, e As EventArgs) Handles TextBoxDocName.TextChanged
...
Public Class FormLoadDoc
    ...
    Private Sub TextBoxLastRevision_TextChanged(sender As Object, e As EventArgs) Handles TextBoxLastRevision.TextChanged
