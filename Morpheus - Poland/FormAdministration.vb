    ...
    Private Sub ButtonSave_Click(sender As Object, e As EventArgs) Handles ButtonSave.Click
        ...
        If TextBoxForUsername.Text <> "" And TextBoxForPassword.Text <> "" And TextBoxForSign.Text <> "" And ListViewForUsers.SelectedItems.Count > 0 Then
            Try
                ...
                returnValue = Regex.IsMatch(TextBoxForSign.Text.ToUpper.Trim, "R[0-9]J[0-9]U[0-9]L[0-9]C[0-9]B[0-9]E[0-9]N[0-9]P[0-9]Q[0-9]S[0-9]F[0-9]I[0-9]A[0-9]T[0-9]W[0-9]Z[0-9]$")
