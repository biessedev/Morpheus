Public Class FormAbaut
    ...
    Private Sub FormAbaut_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        FormStart.Show()
    End Sub
    ...
    Private Sub FormAbaut_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        FormStart.Hide()
